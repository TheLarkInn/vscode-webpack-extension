...
const create = (workspace, context) => {
  const serverModule = context.asAbsolutePath(path.join("src", "servers", "webpackProductionServer.js"));
  ...
  const client = new LanguageClient("production", "Webpack Production Server", serverOptions, clientOptions);
  return client;
};
